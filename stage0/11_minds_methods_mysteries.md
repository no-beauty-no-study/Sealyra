...
Inside every human body operates a small invisible clock that runs not by daylight but by an internal cluster of neurons called the suprachiasmatic nucleus, oscillating at an approximately daily cycle. This is the circadian rhythm. After dusk the pineal gland in the brain secretes the hormone melatonin to induce drowsiness, and at dawn it ceases secretion to permit alertness. The trouble is that human ingenuity has produced electric lighting and the luminous screens of telephones, the blue wavelengths of which deceive the brain into perceiving continued daytime, with the result that the modern biological clock is persistently disrupted and insomnia has reached epidemic proportions. Researchers have also established that sleep is not the brain switching off to rest but instead one of its busiest phases. During deep sleep cerebrospinal fluid flushes accumulated metabolic waste from the tissue, while during the rapid-eye-movement phase the short-term memories of the day are sorted, compressed, and consolidated into long-term storage. People who sleep too little fail to retain what they have learned not because they are lazy but because the brain has had no opportunity to archive it.
...
A pioneering German psychologist named Hermann Ebbinghaus turned himself into his own laboratory animal, memorising long lists of meaningless syllables and recording, over the days that followed, how rapidly he forgot them. He plotted the first forgetting curve in the history of psychology and discovered that retention drops sharply across the earliest interval and considerably more slowly thereafter. From this counter-intuitive shape comes a powerful study technique: rather than rehearsing the material many times in immediate succession, the learner should review it at the precise moments when forgetting is about to claim it, so that each retrieval reinforces the trace a little more durably. This is called spaced repetition. The ancient Greek orators meanwhile had devised an entirely different technique called the memory palace, in which one mentally distributes the items to be remembered across the rooms of a familiar building and retrieves them by strolling through that building in the mind. Both techniques rest on the same modern neurological fact: a memory is not a fixed recording but a structure that the brain rebuilds every time it is recalled, and the more often the structure is rebuilt the firmer its foundations become.
...
For most of history people assumed that the trees of a forest grew as independent individuals, competing in isolation for sunlight and water. Then biologists examining the soil beneath the canopy discovered an enormous underground network. The roots of trees, it turned out, intertwine with a particular kind of fungus whose threadlike filaments weave through the soil and link the trees of an entire forest into a continuous web, popularly nicknamed the wood wide web. Through this network a mature tree can divert surplus sugars to a sick or shaded neighbour, and mother trees can even recognise their own seedlings and nourish them preferentially. When a tree is attacked by insects it releases chemical alarms through the same network so that nearby trees can secrete defensive compounds before the insects arrive. Plants possess no brain, yet they sense the direction of light, register the locations on a stem at which they have been touched, and calculate whether their stored starch will suffice to last the night. They simply live by a logic profoundly different from that of any animal.
...
Monarch butterflies fly each autumn from Canada to a particular small grove of fir trees in central Mexico. Pigeons released far from home find their way back without hesitation. Sea turtles return to the very stretch of beach on which they hatched in order to lay their own eggs, having traversed an entire ocean in between. None of them carries a map or a compass. After patient experiment, biologists have established that many of these creatures contain specialised cells sensitive to the Earth's magnetic field, which orient them as reliably as a built-in compass. In the eyes of certain birds a particular protein actually permits them to perceive the magnetic field directly, almost as a colour superimposed on the visual scene. Other species memorise the configuration of stars, the angle of the sun, the smell of distant coastlines, or the long wave patterns of the open ocean. The strangest case is the monarch, whose annual migration takes several generations to complete a round trip. No individual butterfly has ever survived the full route, and yet the route is written entirely into the species' genes.
...
The brain consists of vast numbers of neurons connecting to one another across tiny chemical gaps called synapses, and the count of simultaneous connections inside it exceeds the count of stars in the Milky Way. A famous railway worker had an iron rod driven through his frontal lobe in a construction accident and survived, but his personality switched abruptly from mild and reliable to impulsive and uncontrolled. The incident gave the first hard evidence that character and moral judgement reside in specific regions of the brain. Subsequent research has established that fear is triggered by a small structure called the amygdala, that memories are consolidated by the hippocampus, and that rational decision-making is supervised by the prefrontal cortex. The most counter-intuitive discovery, however, is that the brain remodels itself throughout life, a property called neuroplasticity. The visual cortex of a blind person is gradually rewired to process touch and sound, and the motor regions of a stroke patient can be coaxed to take over the functions of damaged tissue. Learning any new skill, in this sense, is the physical rewiring of one's own brain at the cellular level.
...
The human intestine houses trillions of bacteria whose combined cell count rivals that of the human cells in the entire body and whose combined mass amounts to roughly a kilogram. For most of medical history bacteria were treated as adversaries to be eradicated. Only recently have researchers established that this enormous resident community, the gut microbiome, functions as an indispensable organ in its own right. It digests dietary fibres that human enzymes cannot break down, synthesises essential vitamins, and trains the immune system to distinguish friend from foe. More striking still, the gut and the brain communicate directly along a dedicated nerve pathway, and the microbes themselves manufacture chemical messengers that influence mood and appetite, so the colloquial reference to a gut feeling may carry literal biological weight. When the gut bacteria of a slim mouse are transplanted into an obese mouse, the obese mouse loses weight. Within a few days of a dietary change the entire community reshuffles itself. Every meal, in effect, reshapes an invisible ecosystem inside you.
...
The human nose can distinguish among an enormous range of separate scents, vastly more than the colours the eye can resolve. Smells trigger powerful and uncannily specific memories because olfactory information takes a shortcut: instead of routing through the thalamus like the other senses, the signal projects directly into the amygdala and the hippocampus, the very regions that store emotion and long-term memory. The French novelist Marcel Proust wrote a celebrated passage in which the scent of a small cake dipped in tea instantly returns the whole of his childhood, and the phenomenon has been named the Proust effect in his honour. Every individual's catalogue of olfactory memory is intensely private, because each scent is linked indelibly to the situation and the emotional state in which it was first encountered, and the association is essentially unbreakable for the rest of a lifetime. A perfume, an old book, the wet pavement after summer rain, each opens a corridor in the brain that no deliberate effort of recall ever quite reaches on its own.
...
Sound is nothing more than the vibration of air, and deep in the ear a spiral organ shaped like the shell of a snail contains thousands of microscopic hair cells. Different positions along the spiral are tuned to different frequencies, so that incoming vibrations agitate different hairs and the brain receives a coded electrical signal that has translated atmospheric motion into perceived pitch. The brain possesses the remarkable ability to lock onto a single voice in a noisy crowded room and filter out everything else, a faculty known as the cocktail party effect that engineers required generations of computation to begin to imitate. Whales have taken sound to an extreme. Their low-frequency songs propagate across vast stretches of ocean, every member of a population sings the same song, and they collaboratively revise the melody from one year to the next. The noise of the modern city, by contrast, persecutes its inhabitants. Prolonged exposure to traffic noise measurably raises blood pressure, disrupts sleep, and degrades hearing. Silence has become an increasingly luxurious resource.
...
Inside the nucleus of every cell coils a long chain called DNA, whose four chemical letters spell out, in arrangements of breathtaking compactness, the complete instructions for assembling an entire human being. A single cell holds a chain longer than a small child folded into a region too small to see. Two young researchers at Cambridge, assisted by the X-ray crystallography of a female colleague named Rosalind Franklin, deduced that DNA takes the form of a double helix: two intertwined strands of complementary bases that, when separated, each serve as a template for the synthesis of a new partner, so that one cell becomes two with the inherited code preserved intact. A long international effort subsequently sequenced the entire human genome, the biological equivalent of a lunar landing. The biochemist Jennifer Doudna later refined the CRISPR system, originally a bacterial defence against viruses, into a precise pair of molecular scissors capable of editing any gene at any location, conferring on our species the power to rewrite its own inheritance and exposing it, for the first time, to the moral question of whether it should.
...
In an English country village an observant doctor named Edward Jenner noticed that milkmaids almost never contracted the lethal disease smallpox, having previously caught a much milder bovine disease called cowpox. He boldly inoculated a small boy with cowpox lymph, and the boy proved subsequently immune to smallpox itself. The technique he had invented is called vaccination, the English word descending from the Latin vacca for cow. The underlying principle is to show the immune system a preview of a pathogen so that the body manufactures matching antibodies in advance, so when the real pathogen arrives the immune system already recognises it on sight. A global vaccination campaign has eradicated smallpox completely, the only human infectious disease ever eliminated. Generations after Jenner, a radical new technology called messenger RNA was deployed in response to the recent coronavirus pandemic. Instead of injecting the virus itself, scientists encoded the genetic instructions for one viral protein and let each patient's own cells manufacture the preview, compressing into months a development cycle that traditionally required a decade.
...
The Swiss scholar Ferdinand de Saussure proposed a disorienting principle: the syllable cat bears no necessary relation to the actual animal, the connection is purely a social convention, and the meaning of any word arises not from the thing it points at but from its difference from the other words around it. Language thereby became a system of signs to be analysed in its own right, and the entire discipline of modern linguistics opened up around the proposal. The American Noam Chomsky later pushed even further, arguing that every human infant arrives equipped with an inherited universal grammar, a deep template common to all languages that any specific language merely fills in with local vocabulary, which is why a small child can acquire fluent grammar that no adult could explicitly articulate. Linguists have also documented a more sombre statistic. Every so often an indigenous language disappears from the planet as its final speaker dies, and each loss extinguishes an entire distinct way of perceiving the world.
...
The Swiss psychologist Jean Piaget devoted decades to observing children, including his own, and demonstrated that small children are not simply little adults who have not yet been told everything but instead reason according to a logic profoundly different from the adult one, advancing through fixed developmental stages. A young infant has not yet acquired the concept of object permanence: a thing that disappears from sight has ceased to exist, which is what makes the game of peekaboo so dramatic for them. A slightly older child believes that the same volume of water poured into a tall narrow glass has somehow increased, because the child has not yet grasped the abstract notion that quantity is conserved across changes of shape. Linguists have also identified a critical window for language acquisition. Children deprived of normal linguistic input during this window, in the rare documented cases of extreme childhood isolation, never master the grammar of any subsequent language, and once the window has closed it cannot be reopened.
...
Every living organism continuously absorbs a slowly decaying form of carbon, and the moment the organism dies the absorption stops and the existing supply diminishes at a steady, predictable rate, like an unalterable hourglass. By measuring how much of that isotope remains in a bone or a piece of wood the archaeologist can infer how long ago it died, a method called radiocarbon dating, accurate well back into prehistory. A more delicate technique relies on tree rings: each year a tree adds one ring, and rings from wet years are wider than those from droughts, so by matching the pattern of an ancient timber against the long catalogue established from living trees the date of the timber can be fixed to the precise year. The most recent and most extraordinary technique extracts ancient DNA directly from bones of immense antiquity. Through this method scientists have established that every modern European still carries a small percentage of Neanderthal DNA, traces of an interbreeding event that the bones themselves had silently preserved.
...
When cholera tore through an industrialising London the prevailing theory blamed foul air, the so-called miasma, exhaled by rotting matter. A physician named John Snow refused to accept it, mapped every recorded death on a chart of the streets, and discovered that the cases formed a tight cluster around a single neighbourhood water pump. He persuaded the authorities to remove the handle of the pump, the epidemic subsided, and the discipline of epidemiology was born along with it. Looking backward across history, the bubonic plague killed roughly a third of medieval Europe and so undermined the moral authority of the church that the entire medieval order began to collapse. Smallpox accompanying the Spanish into the Americas exterminated indigenous populations on a scale large enough to deliver an entire empire into the hands of a small expedition. The great influenza outbreak after the First World War killed more people than the war itself. Each great epidemic, far from being merely a tragedy of mortality, reshapes wage rates, religious authority, town planning, and even habits as small as washing hands.
